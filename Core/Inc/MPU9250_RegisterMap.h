...
#ifndef INC_MPU9250_REGISTERMAP_H_
#define INC_MPU9250_REGISTERMAP_H_

enum mpu9500_register {
	mpu9250_AD0_low = 0x68 << 1,
	mpu9250_AD0_high = 0x69 << 1,
...
#endif /* INC_MPU9250_REGISTERMAP_H_ */
